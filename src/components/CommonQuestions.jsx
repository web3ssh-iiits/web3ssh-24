...
const CommonQuestions = () => {
  ...
  return (
    <div className="font-inter antialiased text-white">
      <main className="min-h-screen flex flex-col justify-center bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#070303] via-[#220E0D] to-[#070303] overflow-hidden">
              ...
              >
                <h2>
                  ...
                  >
                    ...
                    <svg
                      className={`fill-current h-6 w-6 transition-transform duration-200 ease-out ${expandedItem === index + 1
                        ? ""
                        : "rotate-180"
                        }`}
                ...
                <div
                  ...
                  className={`overflow-hidden transition-all duration-500 ease-in-out ${expandedItem === index + 1
