...
const HeroSection = () => {
  ...
  return (
    <div
      className={clsx(
        'flex flex-col items-center justify-start pt-10 h-herosection z-10 text-white',
        'lg:justify-start lg:pt-20',
        'pt-0',
      )}
    >
      <TypewriterEffect words={words} className='px-10 min-h-[220px] lg:min-h-[100px]'/>
      <div className="text-md lg:text-2xl  text-center xl:w-2/5 lg:w-1/2 mt-4 sm:w-3/5 max-[375px]:w-4/5 w-3/4 text-white">
      ...
      <div className="my-2">
      <div className="mt-16 flex flex-col md:flex-row space-y-4 md:space-y-0 space-x-0 md:space-x-4 items-center justify-center">
  <a href="/register">
