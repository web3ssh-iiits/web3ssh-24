      ...
      <div className="disappear w-full right-0 z-10 text-white bg-[#221040] h-20 border-[#32224B] flex p-3 justify-between items-center" >
        ...
        <div className="hidden sm:flex justify-between gap-6 items-center ">
          <ul className="flex gap-6">
            ...
            <li><a href="#" className="hover:bg-[#AE79FF] transition-colors duration-300 px-3 py-1 rounded-md">Schedule</a></li>
            <li><a href="#" className="hover:bg-[#AE79FF] transition-colors duration-300 px-3 py-1 rounded-md">FAQ</a></li>
          </ul>
        </div>
        <div className="flex justify-end items-center gap-6 w-full">
          <ul className="hidden lg:flex gap-6">
            ...
            <li><a href="https://x.com/web3ssh" target="_blank">< Twitter fill="#fff" width="20px" height="20px" className="hover:fill-[#AE79FF]" /></a></li>
            <li><a href="https://www.instagram.com/web3ssh/" target="_blank">< Instagram fill="#fff" width="20px" height="20px" className="hover:fill-[#AE79FF]" /></a></li>
          </ul>
          <a href="early-iiits">
            <button type="button" className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2">Register Now!</button>
          </a>
        </div>
      </div>
