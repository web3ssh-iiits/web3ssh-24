      ...
      <div className="tower">
        <div className="tower__group">
          ...
          <div className="tower__brick-layer">
            ...
            <div className="tower__brick tower__brick--180 tower__brick--move12">
              <div className="tower__brick-side"></div>
              <div className="tower__brick-side"></div>
              <div className="tower__brick-side"></div>
              <div className="tower__brick-side"></div>
            ...
            <div className="tower__brick tower__brick--270 tower__brick--move11">
              <div className="tower__brick-side"></div>
              <div className="tower__brick-side"></div>
              <div className="tower__brick-side"></div>
              <div className="tower__brick-side"></div>
